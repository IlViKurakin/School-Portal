...
MODULE_PATH = (
    ROOT / "portal_ready_documents_v9_9_4.py"
)

MARKER = "READY DOCUMENTS FIX V9.9.4"
...
'''
    ...
    print()
    print(
        "Исправление v9.9.4 установлено."
    )
    print()
    print(
        "Теперь при переводе "
        "в «Готово к зачислению»:"
    )
    print(
    ...
    print(
        "- OCR-расхождение не считается "
        "отсутствием документа;"
    )
    print(
        "- документ на ручной проверке "
        "засчитывается как предоставленный;"
    )
    print(
        "- открытые замечания "
        "по-прежнему блокируют переход."
    )
    print()
    print(
